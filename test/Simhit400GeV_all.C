...
{
 char* filename ="/afs/cern.ch/cms/data/CMSSW/Validation/EcalDigis/data/Photon_E400GeV_all_simevent.root";
 ...
 h1[0] = new TH1F(label[0],"E1x1",50, 1.0e+5, 4.1e+5);
 h1[1] = new TH1F(label[1],"E2x2",50, 2.0e+5, 4.1e+5);
 h1[2] = new TH1F(label[2],"E3x3",50, 3.0e+5, 4.1e+5);
 h1[3] = new TH1F(label[3],"E4x4",50, 3.0e+5, 4.1e+5);
 h1[4] = new TH1F(label[4],"E5x5",50, 3.0e+5, 4.1e+5);
...
// Energy spectrum and Multiplicity in ZMinus side of Preshower
 ...
 TFile OutFile("EcalSimHit_400GeV.root","RECREATE") ;
