...
void Simhit200GeV_all(TString inputfile="simhitoutput.root",
                       TString outputfile="EcalSimHitHisto_200GeV.root")
{
...
// Energy spectrum and Multiplicity in ZMinus side of Preshower
 ...
 //TFile OutFile("EcalSimHitHisto_200GeV.root","RECREATE") ;
