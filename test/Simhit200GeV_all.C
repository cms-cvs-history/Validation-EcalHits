...
void Simhit200GeV_all()
{
 char* filename ="/afs/cern.ch/cms/data/CMSSW/Validation/EcalDigis/data/Photon_E200GeV_all_simevent.root";
 ...
 h1[0] = new TH1F(label[0],"E1x1",50, 0.8e+5, 2.1e+5);
 h1[1] = new TH1F(label[1],"E2x2",50, 1.0e+5, 2.1e+5);
 h1[2] = new TH1F(label[2],"E3x3",50, 1.0e+5, 2.1e+5);
 h1[3] = new TH1F(label[3],"E4x4",50, 1.0e+5, 2.1e+5);
 h1[4] = new TH1F(label[4],"E5x5",50, 1.0e+5, 2.1e+5);
 ...
 h1[19] = new TH1F(label[19],"E1x1",50, 0.8e+5, 2.1e+5);
 h1[20] = new TH1F(label[20],"E2x2",50, 1.0e+5, 2.1e+5);
 h1[21] = new TH1F(label[21],"E3x3",50, 1.0e+5, 2.1e+5);
 h1[22] = new TH1F(label[22],"E4x4",50, 1.0e+5, 2.1e+5);
 h1[23] = new TH1F(label[23],"E5x5",50, 1.0e+5, 2.1e+5);
...
// Energy spectrum and Multiplicity in ZMinus side of Preshower
 ...
 TH2F* h2[NHisto2];
 h2[0] = new TH2F(label2[0], "Longitudinal Profile",26,0,26, 100, 0, 20000);
 h2[1] = new TH2F(label2[1], "Occupancy", 100, -3, 3, 100,-3.15, 3.15);
 h2[2] = new TH2F(label2[2], "Longitudinal Profile",26,0,26, 100, 0, 10000);
 ...
 pro[0] = new TProfile(label3[0],"Preshower EE vs ES energy z+(sample)"   ,100, 0, 300., 0., 250000.);
 pro[1] = new TProfile(label3[1],"Preshower EE vs ES energy z-(sample)"   ,100, 0, 300., 0., 250000.);
 ...
 TFile OutFile("EcalSimHit_200GeV.root","RECREATE") ;
